...
//sort toma los numeros colocalndo el numero de forma tipo ascendente, tomando solo en cuenta el primer elemento del numero, no es muy recomendable usar, y modifica el arreglo. que parece desordenada.
let otrosNumeros = [923, 243 ,34 ,55, 13, 46, 85, 66];
document.write('<br>' + otrosNumeros.sort() + '<br>');

//Reverse, coloca los numero del ultimo al primero
let otrosNumeros2 = [923, 243 ,34 ,55, 13, 46, 85, 66];
document.write('<br>' + otrosNumeros2.reverse() + '<br>')

//find, sirve para encontrar un elemento
